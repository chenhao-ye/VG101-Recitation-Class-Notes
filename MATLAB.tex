...
\begin{itemize}
\item bad variable name:``a1'', ``a2, ``a3'', ``b'', ``c'', ``d'', ``e'', ``f''
...
\end{itemize}
\footnotetext{Not required by VG101 but a good habit.}
\end{frame}
